...
export default function StreakBoard() {
	return (
		<div className="course-status border border-gray-300 min-h-[100px] rounded-2xl mx-8 my-8 grid grid-cols-4 p-8">
			<div className="col-span-2 flex flex-col items-start justify-center ml-2">
				<p className="text-lg font-bold ">Start learning Today ! Start your streak</p>
			...
			<div className="col-span-1 flex flex-row items-center justify-start ml-4">
				<HiOutlineFire color="gray" size={30} />
